...
int main() {
  ...
  unsigned int specularMap = loadTexture("../resources/textures/container2_specular_realistic.png");
  ...
  lightingShader.setInt("material.specular", 1);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // model = glm::mat4(1.0f);
        // model = glm::translate(model, camera.Position);   //camera pos only this case beacuse the flashlight pos is same as camera
